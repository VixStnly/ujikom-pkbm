                                ...
                                <div class="card card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file">
                                            ...
                                            <!-- Preview Gambar Lama -->
                                            @if ($gallery->image)
                                                <img src="{{ asset('storage/' . $gallery->image) }}" alt="{{ $gallery->title }}" class="mt-2 w-48 rounded-md shadow-md">
                                                <p class="mt-2 text-muted">Current Image: {{ $gallery->image }}</p>
                                            @endif
                                    ...
                                    <!-- Display current category based on kategori_id -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="kategori_id" id="kategori_id" class="form-control @error('kategori_id') is-invalid @enderror">
                                            ...
                                            @foreach($categories as $category)
                                                <option value="{{ $category->id }}" {{ $gallery->kategori_id == $category->id ? 'selected' : '' }}>
                                                    {{ $category->name }}
                                                </option>
                                            @endforeach
                                        </select>
