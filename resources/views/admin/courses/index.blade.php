...
<head>
    ...
    <style>
        .card-scroll {
            ...
            max-width: 100%;                          /* Pastikan maksimum lebar 100% */
            height: 100%;                             /* Tinggi kontainer agar tidak terpotong */
            min-width: 880px;                         /* Lebar minimum untuk memastikan tidak terlalu kecil */
        }

        .card-scroll .card {
            flex: 0 0 220px;                          /* Tetapkan lebar tetap untuk kartu */
            max-width: 220px;                         /* Batasi lebar maksimum kartu */
        ...
        .card-body {
            display: flex;                            /* Atur isi kartu */
            justify-content: space-between;           /* Jarak antara judul dan tombol */
            align-items: center;                      /* Rata tengah vertikal */
            padding: 0.5rem;                          /* Padding dalam body kartu */
        }
        ...
        .card-scroll::-webkit-scrollbar-thumb {
            background: rgba(136, 136, 136, 0.5);    /* Warna scrollbar */
            border-radius: 4px;                       /* Sudut melingkar scrollbar */
        }

        .card-scroll::-webkit-scrollbar-thumb:hover {
            background: rgba(136, 136, 136, 0.8);    /* Warna scrollbar saat hover */
        }

        /* Styling tombol edit */
        .btn-edit {
            width: 80px;                              /* Lebar tombol edit */
            height: 30px;                             /* Tinggi tombol edit */
            padding: 0;                               /* Hilangkan padding */
            font-size: 0.75rem;                       /* Ukuran font tombol */
            border-radius: 0.25rem;                   /* Sudut melingkar */
        }
    </style>
</head>
                                                ...
                                                @foreach($kls->subjects as $subject)
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body d-flex justify-content-between align-items-center">
                                                            ...
                                                            <a href="{{ route('admin.courses.edit', $subject->id) }}" class="btn btn-primary btn-edit">Edit</a>
                                                        </div>
                                                    </div>
                                                @endforeach
                                            </div>
