    ...
    <script>
        $(document).ready(function() {
            ...
            $('#helpBtn').on('click', function() {
                Swal.fire({
                    title: 'Bantuan Halaman Tugas',
                    html: `
                        <div class="text-left">
                            <p><b>Di halaman ini, Anda dapat:</b></p>
                            <ul>
                                <li>Melihat semua mata pelajaran yang tersedia</li>
                                <li>Mengakses tugas pertemuan yang sudah ada</li>
                                <li>Membuat pertemuan baru untuk setiap mata pelajaran</li>
                            </ul>
                            <p><b>Petunjuk penggunaan:</b></p>
                            <ol>
                                <li>Klik tombol "Lihat Tugas Pertemuan" untuk melihat daftar pertemuan</li>
                                <li>Pilih salah satu pertemuan untuk melihat tugas yang tersedia</li>
