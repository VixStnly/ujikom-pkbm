...
<head>
    ...
    <!-- Add any CSS or JavaScript links required here -->
            ...
            <form action="{{ route('guru.meeting.store') }}" method="POST" enctype="multipart/form-data">
                ...
                {{ $subject->name }} -  {{ $subject->kelas->name }}
                                ...
                                <div class="form-group mb-24pt">
                                    ...
                                    <input type="text" name="title" id="title" class="form-control" placeholder="Judul Pertemuan" required>
                                    @error('title')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group mb-32pt">
                                    ...
                                    <textarea name="description" id="description" class="form-control" rows="5" placeholder="Deskripsi Pertemuan" required></textarea>
                                    @error('description')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="card">
                                    ...
                                    <div class="list-group list-group-flush">
                                        <div class="list-group-item d-flex">
                                            <a class="flex" href="{{ route('guru.meeting.index') }}"><strong>Kembali</strong></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
