    ...
    <div class="mdk-drawer-layout js-mdk-drawer-layout" data-push data-responsive-width="992px">
        <div class="mdk-drawer-layout__content page-content">
            ...
            <div class="container mx-auto py-6">
                <h2 class="text-2xl font-bold mb-4">Detail Tugas</h2>

                <p><strong>Nama Siswa:</strong> {{ $tugas->student->name }}</p>
                <p><strong>Subjek:</strong> {{ $tugas->meeting->subject->name }}</p>
                <p><strong>Pertemuan:</strong> {{ $tugas->meeting->name }}</p>
                <p><strong>Nilai:</strong> {{ $tugas->score ?? 'Belum dinilai' }}</p>
                <p><strong>Feedback:</strong> {{ $tugas->feedback ?? 'Belum ada feedback' }}</p>
